...
namespace test
{
    public partial class Form_Employee_Info : System.Windows.Forms.Form
    {
        ...
        private void dungeonTextBox3_TextChanged(object sender, EventArgs e)
        {

        }

        private void dungeonTextBox4_TextChanged(object sender, EventArgs e)
        {

        }

        private void dungeonRichTextBox2_TextChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                mydb.openConnection();
                string query = @"INSERT INTO Emloyeesinfo (Experience, TechnicalSkills, InterestsAndHobbies, Education, CoursesAndCertifications, WorkExperience, CareerObjective)  VALUES ( @Experience, @TechnicalSkills, @InterestsAndHobbies, @Education, @CoursesAndCertifications, @WorkExperience, @CareerObjective)";
